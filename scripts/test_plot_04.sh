...
./02_convex -a 2 -e $error --loadparamfile ./param4_1.dat --debug 1 > ./result4_1.dat
./02_convex -a 2 -e $error --loadparamfile ./param4_2.dat --debug 1 > ./result4_2.dat
./02_convex -a 2 -e $error --loadparamfile ./param4_3.dat --debug 1 > ./result4_3.dat
./02_convex -a 2 -e $error --loadparamfile ./param4_4.dat --debug 1 > ./result4_4.dat
./02_convex -a 2 -e $error --loadparamfile ./param4_5.dat --debug 1 > ./result4_5.dat
